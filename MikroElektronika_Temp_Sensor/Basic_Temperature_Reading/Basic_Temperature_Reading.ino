...
fever_init(0x48);
Delay_ms (100);
/*sets the temperature limit to specified value*/
fever_write_temperature (37.80, FEVER_TOS);
/*reads stored temperature limit, with 0.01 rounding error*/ fever_read_temperature_text (uart_text, FEVER_TOS);
UART_Write_Text("rn Current temperature limit for output signal: "); UART_Write_Text(uart_text);
Delay_ms(1000);
}
